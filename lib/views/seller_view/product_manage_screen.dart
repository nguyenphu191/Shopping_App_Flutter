...
class ProductManScreen extends StatefulWidget {
  final User seller;
  const ProductManScreen({super.key, required this.seller});

  @override
  State<ProductManScreen> createState() => _ProductManScreenState();
}

class _ProductManScreenState extends State<ProductManScreen> {
  late User _seller;
  List<ProductModel> _products = [];
  late TextEditingController _searchController = TextEditingController();

  void _getProducts() async {
    final products = await Provider.of<ProductViewModel>(context, listen: false)
        .getUserProducts(_seller.id);
    setState(() {
      _products = products;
    });
  }
                        ...
                        Container(
                          ...
                          child: PopupMenuButton<String>(
                            ...
                            onSelected: (String value) {
                              ...
                              if (value == 'Add') {
                                context.push('/seller/add-product', extra: _seller);
                              }
                            },
                          ),
                        ),
                  ...
                  child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                              child: InkWell(
                            onTap: () => context.push('/product/${product.id}', extra: 'seller'),
                            child: Container(
