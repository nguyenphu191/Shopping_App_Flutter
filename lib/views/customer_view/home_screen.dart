...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    pageController.addListener(() {
      setState(() {
        _currentScreen = pageController.page!;
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child:
          Consumer<ProductViewModel>(builder: (context, productProvider, child) {
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            context.push('/product/${product.id}', extra: 'customer');
                                          },
                                          child: Container(
          ...
          bottomNavigationBar: BottomAppBar(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  onPressed: () => context.push('/profile', extra: user),
                  icon: FaIcon(
