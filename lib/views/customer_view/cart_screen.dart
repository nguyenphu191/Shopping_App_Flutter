  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Consumer<CartViewModel>(builder: (context, cartProvider, child) {
                ...
                child: Container(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () => context.push('/product/${item.product.id}', extra: 'customer'),
                        child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            if (Provider.of<CartViewModel>(context,
                              ...
                              context.push('/order', extra: _selectedItems);
                            }
                          },
                          splashColor:
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                onPressed: () => context.push('/profile', extra: userProvider.user),
